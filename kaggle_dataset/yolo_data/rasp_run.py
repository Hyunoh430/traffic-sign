...
HOME = Path.home()
yolov5_path = HOME / "Downloads/yolov5"
...
# 모델 로드
weights = HOME / "Downloads/best.pt"
device = select_device('cpu')  # GPU 사용 시 'cuda:0', CPU 사용 시 'cpu'
...
# 결과 저장
output_path = HOME / "Downloads/results.jpg"
